    ...
    <div className='min-h-screen bg-gray-50'>
      <div className='max-width-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        {listings && listings.count === 0 && !loading && (
          <div data-testid="no-listings" className='text-center py-16'>
        ...
        {listings && listings.data.length > 0 && !loading && (
          <>
            <div data-testid="marketplace-grid" className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 mb-8'>
