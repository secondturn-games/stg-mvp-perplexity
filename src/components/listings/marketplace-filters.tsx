...
export function MarketplaceFilters({ onFiltersChange, className }: MarketplaceFiltersProps) {
  ...
  return (
    <div data-testid="marketplace-filters" className={cn('bg-white border border-gray-200 rounded-lg p-4 space-y-4', className)}>
      {/* Search Bar */}
      <div className='relative'>
        ...
        <input
          ...
          className={cn(
            'block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white transition-colors',
        ...
        <div id='search-help' className='sr-only'>
          Search for board games by name or description
        </div>
      </div>
